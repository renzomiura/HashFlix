...
from .views import Homepage, Homefilmes, Detalhesfilmes, Pesquisa, EditarPerfil, CriarPerfil
...
urlpatterns = [
    ...
    path('criarperfil/', CriarPerfil.as_view(template_name = 'criarperfil.html'), name = 'criarperfil'),
